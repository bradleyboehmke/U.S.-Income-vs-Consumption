...
The analysis finds that the national-level and average state-level savings rate has remained around 7-8% since 1997. Furthermore, we find that PCI and PCE have grown at a relatively similiar rate at the national and state-levels.  However, the analysis does uncover a noticable shift in the disparity of savings rates across the states in recent years with much of the growth in savings rates being concentrated in the central U.S. states - from the Dakotas down to Oklahoma, Texas and Louisiana.
...
Figure 5 shows that for states that have above average savings rate (left pane) there is no noticable difference in the change of PCE versus PCI.  With the exception of the two outliers in this pane (Wyoming and Oklahoma who experienced significantly higher changes in PCI than the other states) these states have experienced, on average, relatively similiar growth rates in both PCE and PCI. Likewise, for those states that have below average savings rates (right pane), very little difference exists in the average growth rates in PCE and PCI.  North Dakota was an outlier for both PCE and PCI (likely a result from the oil boom) and Nevada experienced the smallest increase in PCI.  However, the difference in growth rates for PCE and PCI in this group is likely not to be statistically significant.
...
Consequently, our analysis finds that the national-level and average state-level savings rate has remained around 7-8% since 1997. Furthermore, we find that PCI and PCE have grown at a relatively similiar rate at the national and state-levels.  This suggests that the U.S. has not experienced a fundamental shift in PCI or PCE; rather, both have steadily grown at a similar rate.  The noticable change that we have seen is a greater disparity in savings rates in recent years with much of the growth in savings rates being concentrated in the central U.S. states from the Dakotas down to Oklahoma, Texas and Louisiana.
